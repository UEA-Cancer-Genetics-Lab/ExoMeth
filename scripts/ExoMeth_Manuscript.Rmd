...
csl: vancouver.csl
---
```{r Base setup, include=FALSE, message=FALSE}
...
ExoMeth_Cohort <- read_csv(here("data", "ExoMeth_Cohort.csv"))
MetsSamples    <- read_csv(here("data", "ExoMeth_Mets.csv"))
...
NanoGenes <- ExoMeth_Cohort %>% 
      select(-Sample_ID, -clin_vars, -outcomes, -MethProbes, -Gleason) %>% 
      colnames
```
